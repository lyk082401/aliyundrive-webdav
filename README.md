...
//主要
implementation "net.xdow:aliyundrive-sdk-openapi:1.3.0"
implementation "net.xdow:aliyundrive-sdk-webapi:1.3.0"

//可选
implementation "net.xdow:webdav:1.3.0"
implementation "net.xdow:webdav-jakarta:1.3.0"
implementation "net.xdow:webdav-javax:1.3.0"
implementation "net.xdow:aliyundrive-webdav-internal:1.3.0"
implementation "net.xdow:aliyundrive-android-core:1.3.0"
implementation "net.xdow:jap-http:1.3.0"
implementation "net.xdow:jap-http-jakarta-adapter:1.3.0"
implementation "net.xdow:jap-http-javax-adapter:1.3.0"
```
## 基础用法
```java
